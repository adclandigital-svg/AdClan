...
export const metadata = {
  ...
  keywords: "privacy policy, adclan digital, data privacy, website policy",
    ...
    <div className="privacy-page">
      <div className="privacy-container">
        ...
        <ul>
          ...
          <li>
            Cookies: small files placed on Your computer or device containing
            browsing information.
          </li>
          <li>Country: Delhi, India</li>
          <li>
            Device: any device that can access the Service such as computer,
            phone, tablet.
          </li>
          <li>
        ...
        <p>
          ...
          browser type, pages visited, time spent, unique device identifiers,
          and diagnostic data.
        </p>

        <h3>Tracking Technologies and Cookies</h3>
        <p>
          We use Cookies, beacons, tags, and scripts to track activity and store
          information. Cookies may be Persistent or Session Cookies.
        </p>

        <ul>
          <li>
            <strong>Necessary / Essential Cookies:</strong> Session cookies for
            authentication and security.
          </li>
          <li>
            <strong>Cookies Policy / Notice Acceptance Cookies:</strong>{" "}
            Persistent cookies to remember consent.
          </li>
          <li>
            <strong>Functionality Cookies:</strong> Persistent cookies to
            remember choices like login and language preferences.
          </li>
        </ul>
        ...
        <p>
          ...
          in this Privacy Policy and legal obligations.
        </p>

        <h3>Transfer of Your Personal Data</h3>
        <p>
          Your information may be processed outside of Your jurisdiction. Your
          submission of information constitutes consent to this transfer.
        </p>

        <h3>Delete Your Personal Data</h3>
        <p>
          You may delete or request deletion of your data via Your Account or by
          contacting Us. Some data may be retained for legal obligations.
        </p>

        <h3>Disclosure of Your Personal Data</h3>
        <p>
          The Company may disclose Personal Data in business transactions, law
          enforcement, or to comply with legal obligations.
        </p>

        <h3>Security of Your Personal Data</h3>
        <p>
          We strive to protect Your data, but no method of transmission over the
          Internet is 100% secure.
        </p>

        <h3>Children’s Privacy</h3>
        <p>
          We do not knowingly collect data from anyone under 13. Parental
          consent is required for minors where applicable.
        </p>
        ...
        <p>
          Changes will be posted on this page. The “Last updated” date will
          reflect updates.
        </p>
