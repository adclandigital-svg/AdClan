...
export default function Page() {
  ...
  const project = {
    slides: [
      {
        title: "IndiaResults.com Emotional Brand Film Campaign",
        category: "Video Production",
        year: "2024",
        client: "INDIARESULTS.COM",
        intro:
          "Adclan created an emotional storytelling-based brand film for IndiaResults.com, showcasing the journey, emotions, and aspirations of students and families during exam result moments through cinematic visuals and relatable storytelling.",
        src: "/projects/india_result/banner.mp4",
      },
    ],
  };

  const caseStudy = {
    title: "IndiaResults.com Student Emotion Brand Campaign",
    subtitle: "Brand Film Production & Emotional Storytelling",
    description:
      "Adclan executed a cinematic brand film campaign for IndiaResults.com focused on capturing the emotional connection between students, parents, and academic success. The campaign highlighted the anticipation, pressure, happiness, and family support associated with exam results through powerful storytelling and realistic visuals.",
    duration: "2 Months",
    client: "IndiaResults.com",
    services: [
    ...
    result:
      "The campaign strengthened emotional engagement, increased audience connection with the brand, and enhanced IndiaResults.com’s digital visibility through relatable storytelling and cinematic execution.",
    video: "/projects/india_result/banner.mp4",
  };
