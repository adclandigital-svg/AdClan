...
export default function ProjectPage() {
  const works = [
    ...
    // },
    {
      ...
      icon: "🎧",
      link: "/projects/ims-noida/radio-jingles",
    },
    // {
  ...
  return (
    <div className="project-page">
      ...
      <div className="project-hero1">
        <div className="hero-badge">Radio Jingle Campaign</div>

        <h1>IMS Noida</h1>

        <p className="hero-sub">
          We crafted a high-impact radio jingle campaign for IMS Noida, focused
          on boosting brand recall, increasing student engagement, and
          strengthening regional awareness through strategic audio storytelling
          and high-frequency radio placements.
        </p>
