...
export default function Homereels() {
  ...
  display: flex;
  justify-content: center; /* ✅ LEFT ALIGN FIX */
  align-items: center;
}

/* Swiper container */
.mySwiper {
  width: 1050px; /* control layout width */
  height: 100%;
  overflow: hidden;
...
/* Center card */
.swiper-slide-active .reel-video {
  width: 350px;
  height: auto;
  opacity: 1;
...
@media (max-width: 576px) {
  .thumb-slide-outer {
    flex-wrap: nowrap; /* ❗ switch to scroll */
    overflow-x: auto;
  ...
  .thumb-slide-outer::-webkit-scrollbar {
    display: none;
  }
