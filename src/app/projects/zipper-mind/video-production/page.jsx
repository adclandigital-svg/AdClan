...
export default function Page() {
  ...
  const project = {
    slides: [
      {
        title: "Zipper Minds Study Abroad Brand Campaign",
        category: "Video Production",
        year: "2024",
        client: "ZIPPER MINDS",
        intro:
          "Professional video production and digital campaign for Zipper Minds, creating engaging promotional videos focused on study abroad opportunities, student guidance, scholarships, and international education consulting.",
        src: "/projects/zipperminds/Untitled design (1).mp4",
      },
    ],
  };

  const caseStudy = {
    title: "Zipper Minds International Education Campaign",
    subtitle: "Video Production & Digital Branding",
    description:
      "Adclan executed a complete branding and video production campaign for Zipper Minds, creating visually engaging educational promotional content focused on study abroad programs, student counseling, scholarships, and global career opportunities.",
    duration: "3 Months",
    client: "Zipper Minds",
    services: ["Video Production", "Brand Campaign", "Digital Marketing"],
    result:
      "Increased student inquiries, improved digital engagement, and strengthened Zipper Minds’ online presence across social media platforms.",
    video: "/projects/zipperminds/Untitled design (1).mp4",
  };
